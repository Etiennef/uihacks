...
class PluginUihacksForcechoiceconfig extends PluginConfigmanagerConfig {
   ...
   static function makeConfigParams() {
      return array(
         ...
         'is_activated_for_type' => array(
            'type' => 'dropdown',
            'types' => array(self::TYPE_PROFILE, self::TYPE_GLOBAL),
            'maxlength' => 25,
            'text' => __('Force explicit type choice on ticket creation', 'uihacks'),
            'values' => array(
         ...
         'is_activated_for_urgency' => array(
               'type' => 'dropdown',
               'types' => array(self::TYPE_PROFILE, self::TYPE_GLOBAL),
               'maxlength' => 25,
               'text' => __('Force explicit urgency choice on ticket creation', 'uihacks'),
               'values' => array(
                     '1' => Dropdown::getYesNo('1'),
                     '0' => Dropdown::getYesNo('0')
               ),
