    ...
    static function makeConfigParams() {
        ...
        return array(
            ...
            'disabled' => array(
                ...
                'values' => array(
                        'no' => Dropdown::getYesNo('0'),
                        'disabled' => __('Disabled but visible', 'uihacks'),
                        'totext' => __('Converted to simple text', 'uihacks'),
                        'hidden' => __('Hidden', 'uihacks'),
                        'hiddenS' => __('Hidden, and siblings hidden too', 'uihacks'),
                        'hiddenP1' => __('Parent is hidden', 'uihacks'),
                        'hiddenP2' => __('Great-parent is hidden', 'uihacks'),
                        'hiddenP3' => __('Great-great-parent is hidden', 'uihacks')
                ),
                'tooltip' => __('If anything but no is selected, this input will be disabled and the user won\'t be able to edit it. Keep in mind that it is only client-side modification, it has to be considered as a hint for the user not to edit this field, not a true right management. Also, if you disable fileds in creation forms, it may make the creation impossible.', 'uihacks'),
                'default' => '0',
            )
        );
    }
